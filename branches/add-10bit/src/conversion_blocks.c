...
#define		DECLARE_NNB_CONV_BLOCK2(convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, desc_str_prefix)\
...
#define		DECLARE_NNB_BT601_CONV_BLOCK2(bt601_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, desc_str_prefix)\
...
#define		DECLARE_NNB_BT709_CONV_BLOCK2(bt709_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, desc_str_prefix)\
 ...
 */
#define		DECLARE_CONV_BLOCKS(convert_fn_prefix, resample_n_convert_fn_prefix, non_sse_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix)\
 ...
 * - Fast Nearest NeighBour resampling NON-SSE bt.709
 */
#define		DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_fn_prefix, non_sse_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix)\
DECLARE_NNB_SSE2_SSSE3_CONV_BLOCK		(convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix),\
DECLARE_NNB_BT601_SSE2_SSSE3_CONV_BLOCK	(convert_fn_prefix##_bt601, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix),\
DECLARE_NNB_BT709_SSE2_SSSE3_CONV_BLOCK	(convert_fn_prefix##_bt709, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix),\
DECLARE_NNB_SSE2_CONV_BLOCK				(convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix),\
DECLARE_NNB_BT601_SSE2_CONV_BLOCK		(convert_fn_prefix##_bt601, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix),\
DECLARE_NNB_BT709_SSE2_CONV_BLOCK		(convert_fn_prefix##_bt709, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix),\
DECLARE_NNB_CONV_BLOCK2					(non_sse_convert_fn_prefix, src_fmt, dst_fmt, 2, 2, desc_str_prefix),\
DECLARE_NNB_BT601_CONV_BLOCK2			(non_sse_convert_fn_prefix##_bt601, src_fmt, dst_fmt, 2, 2, desc_str_prefix),\
DECLARE_NNB_BT709_CONV_BLOCK2			(non_sse_convert_fn_prefix##_bt709, src_fmt, dst_fmt, 2, 2, desc_str_prefix)
...
#define		DECLARE_REPACK_CONV_BLOCK(convert_fn_prefix, non_sse_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix)\
...
#define		DECLARE_V210_REPACK_CONV_BLOCK(convert_fn_prefix, non_sse_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix)\
 ...
 * - Fast Nearest NeighBour resampling NON-SSE bt.709
 */
#define		DECLARE_V210_CONV_BLOCKS(convert_fn_prefix, resample_n_convert_fn_prefix, non_sse_convert_fn_prefix, src_fmt, dst_fmt, width_mult_count, height_mult_count, row_pix_mult, desc_str_prefix)\
...
const struct  ConversionBlock		conversion_blocks[] = {
	...
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_argb_to_yuv420p, convert_rgb_to_yuv420, PixFcARGB, PixFcYUV420P, 32, 2, 1, "ARGB to YUV420P"),

	// ARGB to v210
	DECLARE_V210_CONV_BLOCKS(convert_argb_to_v210, downsample_n_convert_argb_to_v210, convert_rgb_to_v210, PixFcARGB, PixFcV210, 16, 1, 48, "ARGB to v210"),
	...
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_bgra_to_yuv420p, convert_rgb_to_yuv420, PixFcBGRA, PixFcYUV420P, 32, 2, 1, "BGRA to YUV420P"),

	// BGRA to v210
	DECLARE_V210_CONV_BLOCKS(convert_bgra_to_v210, downsample_n_convert_bgra_to_v210, convert_rgb_to_v210, PixFcBGRA, PixFcV210, 16, 1, 48, "BGRA to v210"),
	...
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_rgb24_to_yuv420p, convert_rgb_to_yuv420, PixFcRGB24, PixFcYUV420P, 32, 2, 1, "RGB24 to YUV420P"),

	// RGB24 to v210
	DECLARE_V210_CONV_BLOCKS(convert_rgb24_to_v210, downsample_n_convert_rgb24_to_v210, convert_rgb_to_v210, PixFcRGB24, PixFcV210, 16, 1, 48, "RGB24 to v210"),
	...
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_bgr24_to_yuv420p, convert_rgb_to_yuv420, PixFcBGR24, PixFcYUV420P, 32, 2, 1, "BGR24 to YUV420P"),

	// BGR24 to v210
	DECLARE_V210_CONV_BLOCKS(convert_bgr24_to_v210, downsample_n_convert_bgr24_to_v210, convert_rgb_to_v210, PixFcBGR24, PixFcV210, 16, 1, 48, "BGR24 to v210"),


	//
	// YUYV to ARGB
	DECLARE_CONV_BLOCKS(convert_yuyv_to_argb, upsample_n_convert_yuyv_to_argb, convert_yuv422i_to_any_rgb, PixFcYUYV, PixFcARGB, 16, 1, 1, "YUYV to ARGB"),

	// YUYV to BGRA
	DECLARE_CONV_BLOCKS(convert_yuyv_to_bgra, upsample_n_convert_yuyv_to_bgra, convert_yuv422i_to_any_rgb, PixFcYUYV, PixFcBGRA, 16, 1, 1, "YUYV to BGRA"),

	// YUYV to RGB24
	DECLARE_CONV_BLOCKS(convert_yuyv_to_rgb24, upsample_n_convert_yuyv_to_rgb24, convert_yuv422i_to_any_rgb, PixFcYUYV, PixFcRGB24, 16, 1, 1, "YUYV to RGB24"),

	// YUYV to BGR24
	DECLARE_CONV_BLOCKS(convert_yuyv_to_bgr24, upsample_n_convert_yuyv_to_bgr24, convert_yuv422i_to_any_rgb, PixFcYUYV, PixFcBGR24, 16, 1, 1, "YUYV to BGR24"),

	// YUYV to YUV422P
	DECLARE_REPACK_CONV_BLOCK(convert_yuyv_to_yuv422p, convert_yuv422i_to_yuv422p, PixFcYUYV, PixFcYUV422P, 32, 1, 1, "YUYV to YUV422P"),

	// YUYV to V210
	DECLARE_V210_REPACK_CONV_BLOCK(convert_yuyv_to_v210, convert_yuv422i_to_v210, PixFcYUYV, PixFcV210, 16, 1, 48, "YUYV to v210"),


	//
	// UYVY to ARGB
	DECLARE_CONV_BLOCKS(convert_uyvy_to_argb, upsample_n_convert_uyvy_to_argb, convert_yuv422i_to_any_rgb, PixFcUYVY, PixFcARGB, 16, 1, 1, "UYVY to ARGB"),

	// UYVY to BGRA
	DECLARE_CONV_BLOCKS(convert_uyvy_to_bgra, upsample_n_convert_uyvy_to_bgra, convert_yuv422i_to_any_rgb, PixFcUYVY, PixFcBGRA, 16, 1, 1, "UYVY to BGRA"),

	// UYVY to RGB24
	DECLARE_CONV_BLOCKS(convert_uyvy_to_rgb24, upsample_n_convert_uyvy_to_rgb24, convert_yuv422i_to_any_rgb, PixFcUYVY, PixFcRGB24, 16, 1, 1, "UYVY to RGB24"),

	// UYVY to BGR24
	DECLARE_CONV_BLOCKS(convert_uyvy_to_bgr24, upsample_n_convert_uyvy_to_bgr24, convert_yuv422i_to_any_rgb, PixFcUYVY, PixFcBGR24, 16, 1, 1, "UYVY to BGR24"),

	// UYVY to YUV422P
	DECLARE_REPACK_CONV_BLOCK(convert_uyvy_to_yuv422p, convert_yuv422i_to_yuv422p, PixFcUYVY, PixFcYUV422P, 32, 1, 1, "UYVY to YUV422P"),

	// YUYV to V210
	DECLARE_V210_REPACK_CONV_BLOCK(convert_uyvy_to_v210, convert_yuv422i_to_v210, PixFcUYVY, PixFcV210, 16, 1, 48, "UYVY to v210"),
	...
	//
	// YUV420P to ARGB
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_yuv420p_to_argb, convert_yuv420p_to_any_rgb, PixFcYUV420P, PixFcARGB, 32, 2, 1, "YUV420P to ARGB"),
	
	// YUV420P to BGRA
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_yuv420p_to_bgra, convert_yuv420p_to_any_rgb, PixFcYUV420P, PixFcBGRA, 32, 2, 1, "YUV420P to BGRA"),
	
	// YUV420P to RGB24
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_yuv420p_to_rgb24, convert_yuv420p_to_any_rgb, PixFcYUV420P, PixFcRGB24, 32, 2, 1, "YUV420P to RGB24"),

	// YUV420P to BGR24
	DECLARE_YUV420P_NNB_ONLY_CONV_BLOCKS(convert_yuv420p_to_bgr24, convert_yuv420p_to_any_rgb, PixFcYUV420P, PixFcBGR24, 32, 2, 1, "YUV420P to BGR24"),


	//
	// v210 to ARGB
	DECLARE_V210_CONV_BLOCKS(convert_v210_to_argb, upsample_n_convert_v210_to_argb, convert_v210_to_any_rgb, PixFcV210, PixFcARGB, 16, 1, 48, "v210 to ARGB"),

	// v210 to BGRA
	DECLARE_V210_CONV_BLOCKS(convert_v210_to_bgra, upsample_n_convert_v210_to_bgra, convert_v210_to_any_rgb, PixFcV210, PixFcBGRA, 16, 1, 48, "v210 to BGRA"),

	// v210 to RGB24
	DECLARE_V210_CONV_BLOCKS(convert_v210_to_rgb24, upsample_n_convert_v210_to_rgb24, convert_v210_to_any_rgb, PixFcV210, PixFcRGB24, 16, 1, 48, "v210 to RGB24"),

	// v210 to BGR24
	DECLARE_V210_CONV_BLOCKS(convert_v210_to_bgr24, upsample_n_convert_v210_to_bgr24, convert_v210_to_any_rgb, PixFcV210, PixFcBGR24, 16, 1, 48, "v210 to BGR24"),

	// v210 to YUYV
	DECLARE_V210_REPACK_CONV_BLOCK(convert_v210_to_yuyv, convert_v210_to_yuv422i, PixFcV210, PixFcYUYV, 16, 1, 48, "v210 to YUYV"),

	// v210 to UYVY
	DECLARE_V210_REPACK_CONV_BLOCK(convert_v210_to_uyvy, convert_v210_to_yuv422i, PixFcV210, PixFcUYVY, 16, 1, 48, "v210 to UYVY"),
};
